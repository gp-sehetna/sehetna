...
export default function ServicesPoliciesHero() {
    return (
        <SectionShell
            ...
            containerClassName="max-w-4xl items-center gap-5 text-center lg:px-8 lg:py-12"
        >
            <motion.div
                {...fadeUp}
                className="bg-background glassy-chip inline-flex items-center gap-2 rounded-full px-4 py-2 shadow-md"
            >
            ...
            <motion.div
                {...fadeUp}
                className="flex items-center justify-center gap-1.5 text-xs text-neutral-500"
            >
                <Clock size={12} />
