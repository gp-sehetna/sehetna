...
const variants = {
    outline: clsx(
        "bg-neutral-100 border border-neutral-1000",
        "hover:bg-neutral-200",
        "active:bg-neutral-300"
    ),
    black: clsx(
        "bg-black border border-neutral-1000 text-neutral-100",
        "hover:bg-neutral-1000 hover:opacity-90",
        "active:opacity-80"
    ),

    gradient: clsx("special-gradient text-neutral-100 border-none base-transition"),
}
