...
from src.domain.schemas.agent import SimulationOutcomes
...
class AgentService:
    ...
    async def interpret(self, country: str, simulation_outcomes: SimulationOutcomes , environmental_data: dict) -> str:
        """
        ...
        try: 
            ...
            raise AgentInferenceError(
                f"Interpreter agent failed: {exc}"
            ) from exc
