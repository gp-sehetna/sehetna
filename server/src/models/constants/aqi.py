...
- PM2.5 ("pm25") — fine particulate matter in µg/m³ (24-hour)
- PM10 ("pm10") — coarse particulate matter in µg/m³ (24-hour)
...
---------------------------------
- To get the AQI for a PM2.5 concentration of 25 µg/m³, use the pm25 breakpoint
...
### O₃ (ppm) – 1-hour > Only used when 8-h ozone ≥ 0.071 (EPA rule)
O3_1H_BREAKPOINTS = [
    (0.125, 0.164, 101, 150),
    (0.165, 0.204, 151, 200),
    (0.205, 0.404, 201, 300),
