...
from src.models.helpers.mixins import CountryIQRCapper, FeatureEngineerMixin
...
def main():
    ...
    archive_name = "[modelling_phase_v5]-lgbm_fold_ensemble"
...
# to run this script use: python -m src.models.pipelines.lgbm

# joblib.dump(pipeline, os.path.join(MODELS_DIR, "[modelling_phase_v5]-pipeline.joblib"))
